...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderNotifications(filter = 'all') {
        ...
        document.querySelectorAll('.mark-read-btn').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                if (notification) {
                    // Update the 'read' field in the Firestore document
    ...
    function updateSelectedLinesDisplay() {
        ...
        selectedLines.forEach(line => {
            ...
            lineTag.dataset.value = line; // Store the value for form submission
            lineTag.innerHTML = `
    ...
    notificationForm.addEventListener('submit', function(e) {
        ...
        const linesToSend = selectedLines.length > 0 ? selectedLines : ['red', 'blue', 'green', 'yellow'];
