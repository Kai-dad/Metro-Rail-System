...
const routes = {
    ...
    "pretoria-dewildt": { name: "Pretoria → De Wildt", origin: "Pretoria", destination: "De Wildt", substations: [{ name: "Saulsville", stopTime: 2 }, { name: "Atteridgeville", travelTime: 5, stopTime: 2 }, { name: "Kalafong", travelTime: 5, stopTime: 2 }, { name: "Corona", travelTime: 5, stopTime: 2 }, { name: "Elandsfontein", travelTime: 5, stopTime: 2 }, { name: "Hercules", travelTime: 5, stopTime: 2 }, { name: "Pretoria-West", travelTime: 5, stopTime: 2 }, { name: "Pretoria", travelTime: 5 }], price: "R7.20", originCoords: [-25.7548, 28.1868], destCoords: [-25.61248, 27.91062], color: '#2ecc71' }
};
